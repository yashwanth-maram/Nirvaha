  ...
  return (
    <SidebarProvider defaultOpen={false}>
      <div className="min-h-screen flex w-full bg-gray-50 relative">
        <Sidebar collapsible="offcanvas" className="bg-white border-r border-emerald-200 shadow-lg z-50">
          <SidebarHeader className="p-4 border-b border-emerald-200">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <h2 className="text-black font-bold text-lg truncate">Admin Panel</h2>
                <p className="text-gray-700 text-xs truncate">Nirvaha Wellness</p>
              </div>
            </div>
          </SidebarHeader>
          <SidebarContent>
          ...
          <SidebarFooter className="p-4 border-t border-emerald-200">
        ...
        <main className="flex-1 flex flex-col min-w-0 relative">
          <header className="h-16 border-b border-emerald-200 bg-white shadow-sm flex items-center justify-between px-6 sticky top-0 z-30">
            <div className="flex items-center gap-4">
              <SidebarTrigger className="text-emerald-700 hover:bg-emerald-50" />
              <div>
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 px-4 py-2 bg-emerald-50 border border-emerald-200 rounded-lg">
                ...
                <span className="text-black text-sm font-medium">Administrator</span>
              </div>
            </div>
          </header>
